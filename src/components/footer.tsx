    ...
    <div className="footer">
      ...
      <div className="right-contents">
        ...
        <a href="https://www.facebook.com/profile.php?id=100005786705952">
          <img src="/images/facebook-footer.png" alt="Teléfono" className="footer-telefono w-6 h-6 mr-2" />
          </a>
        </div>
        <div className="flex items-center">
          <a href="https://www.linkedin.com/in/diego-herrera-lópez-aa825630b/">
          <img src="/images/likedin-footer.png" alt="email" className="footer-linkedin w-6 h-6 mr-2" />
          </a>
        </div>
      </div>
    </div>
